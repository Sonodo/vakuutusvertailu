...
const pohjola: InsuranceProvider = {
  ...
  concentrationBenefits:
    'OP-bonusjärjestelmä on markkinoiden kattavimpia: omistaja-asiakkaat kerryttävät bonusta kaikista OP-palveluista (lainat, talletukset, sijoitukset, vakuutukset). Bonus voi olla jopa 17 % vakuutusmaksuista, mikä tekee kokonaishinnasta kilpailukykyisen erityisesti paljon OP-palveluja käyttäville.',
  onlineCapabilities: [
...
const lahitapiola: InsuranceProvider = {
  ...
  strengths: [
    ...
    'Vahva maatilavakuutustarjonta Suomessa',
...
const ifInsurance: InsuranceProvider = {
  ...
  products: [],
  strengths: [
    'Erinomainen digitaalinen käyttökokemus — erittäin hyvä verkkopalvelu',
...
const ifProducts: InsuranceProduct[] = [
  ...
  },
  {
    ...
    highlights: [
      'Testivoittaja — menestynyt useissa kuluttajavertailuissa',
  ...
  },
  {
    ...
    highlights: [
      'If:n laajin autoturva — sisältää kaiken',
...
const alandia: InsuranceProvider = {
  ...
  products: [],
  strengths: [
    'Merivakuutusten markkinajohtaja — vahva osaaminen vene- ja laivavakuutuksissa',
