  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-lg bg-[#0d9488] px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#0f766e] transition-colors"
      >
      ...
      {showGoogleButton && (
        <div className="absolute right-0 top-full mt-2 bg-white rounded-xl shadow-lg border border-slate-200 p-4 z-50">
          <p className="text-xs text-slate-500 mb-3">Kirjaudu Valitse-tililla</p>
