          ...
          <div className="mb-6 rounded-xl bg-amber/5 border border-amber/20 p-4">
            <div className="flex gap-2">
              ...
              <p className="text-sm text-gray-600">
                ...
                Lopullinen vakuutusmaksu määräytyy vakuutusyhtiön omassa laskurissa
                ja riippuu yksilöllisistä tekijöistä (ajohistoria, asuinpaikka, muut vakuutukset).
                Pyydä virallinen tarjous yhtiöltä ennen päätöstä.
              </p>
            </div>
          </div>
